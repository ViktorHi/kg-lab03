...
import static com.vikras.processor.util.Images.colorToRGB;
import static com.vikras.processor.util.Images.imageHistogram;

public class LinearContrast {
    static public BufferedImage whiteBalanceBuffImage(BufferedImage image) {
